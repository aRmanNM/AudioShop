...
export class CoursesAndEpisodesService {
  ...
  getCourses(search: string, pageIndex: number, pageSize: number, category: string, courseType: number = 0, onlyFeatured = false): Observable<PaginatedResult<Course>> {
